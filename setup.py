...
jstargets = [pjoin(HERE, "lib", "api.js"), ]

package_data_spec = {name: ["*"]}

data_files_spec = [
    ("share/jupyter/lab/extensions", lab_path, "*.tgz"),
    ("etc/jupyter/jupyter_notebook_config.d", "jupyter-config", "jlab_ext_example.json"),
]

cmdclass = create_cmdclass("jsdeps",
                           package_data_spec=package_data_spec,  # 希望被打包的文件
...
setup_args = dict(
    ...
    include_package_data=True,  # include_package_data = True，包含包数据
